...
To view the guide for the new design using the newest sensor and the vibrating motor, see the [Distance-Sensing-Arm-Second-Version](https://github.com/enable-medellin/Distance-Sensing-Arm-Prosthetic-Prototype/wiki/Distance-Sensing-Arm-Second-Version).
